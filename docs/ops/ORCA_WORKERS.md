...
> v1.2.0 은 같은 세션의 포트 배정 번호(W1 8901/9901, W2 8902/9902)를 5장에 기록합니다.
...
2026-09-26 크롬 측정 세션의 배정 기록은 다음과 같습니다. W1 은 HTTP 8901, 디버깅 9901 입니다. W2 는 HTTP 8902, 디버깅 9902 입니다. 이 번호는 그 세션의 기록입니다. 다음 병렬 측정은 사용 중이 아닌 번호를 명세에 다시 적습니다.
